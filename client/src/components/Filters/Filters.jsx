...
const Filters = () => {
  ...
  const sortedTeams = () => {
        const sorted = teams.sort((a, b) => a.name.localeCompare(b.name)) // Ordenar el arreglo alfabéticamente por el nombre del equipo
        
        return sorted.map((team) => ( // Utilizar map para crear un arreglo de elementos JSX
  ...
  return (
    <div>
      ...
      <select
        ...
        <option value="filterByOrigin" disabled="disabled">
          Filter by origin
        </option>
      ...
      <select
        ...
        <option value="filterByTeam" disabled="disabled">
          Filter by team
        </option>
        {sortedTeams()}
      </select>
